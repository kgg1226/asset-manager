...
export default function GuidePage() {
  ...
  const GUIDE_SECTIONS: GuideSection[] = useMemo(() => [
    ...
    },
    {
      ...
      title: t.guide.piiManagementTitle,
      subtitle: t.guide.piiManagementDesc,
      steps: [
        {
          id: "p1",
          title: t.guide.piiCatalogGuide,
          description: t.guide.piiCatalogGuideDesc,
          details: [t.guide.piiCatalogDetail1, t.guide.piiCatalogDetail2, t.guide.piiCatalogDetail3],
        },
        {
          id: "p2",
          title: t.guide.piiItemsEditorGuide,
          description: t.guide.piiItemsEditorGuideDesc,
          details: [t.guide.piiItemsEditorDetail1, t.guide.piiItemsEditorDetail2, t.guide.piiItemsEditorDetail3],
        },
        {
          id: "p3",
          title: t.guide.piiLifecycleGuide,
          description: t.guide.piiLifecycleGuideDesc,
          details: [t.guide.piiLifecycleDetail1, t.guide.piiLifecycleDetail2, t.guide.piiLifecycleDetail3],
        },
        {
          id: "p4",
          title: t.guide.piiFlowReportGuide,
          description: t.guide.piiFlowReportGuideDesc,
          details: [t.guide.piiFlowReportDetail1, t.guide.piiFlowReportDetail2, t.guide.piiFlowReportDetail3],
          link: { href: "/reports", label: t.guide.reportLink },
        },
        {
          id: "p5",
          title: t.guide.assetMapPiiGuide,
          description: t.guide.assetMapPiiGuideDesc,
          details: [t.guide.assetMapPiiDetail1, t.guide.assetMapPiiDetail2, t.guide.assetMapPiiDetail3],
          link: { href: "/asset-map", label: t.guide.assetMapLink },
        },
      ],
    },
    {
    ...
    },
    {
      ...
      steps: [
        ...
        {
          id: "a6",
          title: t.guide.featureFlagsGuide,
          description: t.guide.featureFlagsGuideDesc,
          details: [
            t.guide.featureFlagsDetail1,
            t.guide.featureFlagsDetail2,
            t.guide.featureFlagsDetail3,
            t.guide.featureFlagsDetail4,
            t.guide.featureFlagsDetail5,
            t.guide.featureFlagsDetail6,
            t.guide.featureFlagsDetail7,
          ],
          link: { href: "/admin/feature-flags", label: t.guide.featureFlagsGuide },
        },
      ],
    },
  ], [t]);
        ...
        <div className="mt-8 rounded-lg bg-blue-50 p-5" data-tour="guide-quick-links">
          ...
          <div className="grid grid-cols-2 gap-2 sm:grid-cols-3 md:grid-cols-4">
            {[
              ...
              { href: "/asset-map", label: t.guide.assetMapLink },
