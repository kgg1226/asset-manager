...
export type TranslationDict = {
  ...
  org: {
    ...
    privacyEmployees: string;
    budgetSection: string;
    budgetItPercent: string;
    budgetSecurityPercent: string;
    budgetPrivacyPercent: string;
    certSection: string;
    certStaffCount: string;
    certDurationDays: string;
    ismsStaffTypeSection: string;
    ismsStaffTypeInternalOnly: string;
    ismsStaffTypeExternalOnly: string;
    ismsStaffTypeMixed: string;
    costSection: string;
    consultingCostRange: string;
    consultingCostNone: string;
    consultingCostUnder30M: string;
    consultingCost30M50M: string;
    consultingCost50M100M: string;
    consultingCost100M200M: string;
    consultingCostOver200M: string;
    systemPurchaseCost: string;
    systemPurchaseCostUnit: string;
    disclosureSection: string;
    disclosesSecurityActivity: string;
    otherCertsSection: string;
    hasPiaDiagnosis: string;
    hasPia: string;
    hasIso27001: string;
    hasCriticalInfra: string;
    otherCertifications: string;
    improvementSection: string;
    improvementBudget: string;
    improvementExecAwareness: string;
    improvementNewOrg: string;
    improvementEmployeeAwareness: string;
    improvementLowerRisk: string;
    improvementCustomerTrust: string;
    benefitSection: string;
    benefitCompliance: string;
    benefitSecurityLevel: string;
    benefitOrgAuthority: string;
    benefitCustomerTrust: string;
